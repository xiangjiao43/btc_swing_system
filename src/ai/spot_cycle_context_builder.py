...
_FACTOR_SOURCE = {
    ...
    "lth_sopr": "glassnode_onchain",
    "sth_sopr": "glassnode_onchain",
    "percent_supply_in_profit": "glassnode_onchain",
    "percent_supply_in_loss": "glassnode_onchain",
    "exchange_balance": "glassnode_onchain",
    "exchange_net_position_change": "glassnode_onchain",
        ...
        *,
        ...
        available = {
            ...
            "onchain_valuation": {
                ...
                "percent_supply_in_loss": metric("percent_supply_in_loss"),
            },
            "holder_behavior": {
            ...
            "onchain_holder_behavior": {
                ...
                "exchange_net_position_change": metric("exchange_net_position_change"),
            },
            "exchange_and_flows": {
