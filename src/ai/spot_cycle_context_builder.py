...
_UNAVAILABLE_MODEL_FACTORS = {
    ...
    "percent_supply_in_profit": "not_found",
    "percent_supply_in_loss": "not_found",
    "lth_net_position_change": "not_found",
    "lth_sopr": "config_only",
    "sth_sopr": "config_only",
    "liveliness": "config_only",
    "exchange_balance": "not_found",
    "exchange_net_position_change": "not_found",
